...
int main()
{
    ...
    while(1)
    {
        ...
        *cur = new_sock;
        // pthread_t tid;
        // pthread_create(&tid, NULL, handler_request,(void*)(int64_t)new_sock);
        pool_add_work(&pool,handler_request,(void*)cur);
